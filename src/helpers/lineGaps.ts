...
const itemFillsGap = (g: Gap, e: B, i: Item | null) => e && g.hasPoints && i && g.is(i);
        ...
        for (const [gap, ls, skip] of line.getGaps(true)) {
            ...
            if (noItemForGap(gap, equality, item))
                ...
                if (noItemForGap(gap, equalityE, itemE)
                    ...
                    if (line.shouldAddDots(item.index)[1])
                    ...
                    if (line.shouldAddDots(itemE.index)[0])
