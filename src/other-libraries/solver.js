...
import { intersectSorted, IntrusiveQueue, hWord, lWord } from './basesolver';
...
export function CellPairNode(epuz, puz, cell1, cell2, rnodes1, rnodes2) {
...
export function GapPairNode(epuz, puz, node1, node2, cellpairs_dict, cellpairs_rev) {
    this.node1 = node1;
    this.node2 = node2;
...
export function EdgePuzzle(puz) {
    this.puz = puz;
