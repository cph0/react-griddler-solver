...
import { Puzzle, CellNode, GapNode, makePair } from './basesolver';
import { EdgePuzzle } from './solver';
import { sort, sum, assert } from './util';
...
export default function createPuzzle(data, callback) {
